<?php
/**
* Template Name: Community Events Page
*
			...
			<div id="content">
					...
					<div class="row">
						...
						<div id="main" class="col-md-8 " role="main">
                            <h1> Events Around Central Florida </h1>
                            <br>
                        <?php
                               $posts = 7;
                               if(isset($_GET['posts'])) {
                               ...
                               $args = array(
                                   'post_type' => array('communityevent'),
                                   'showposts' => $posts,
                                   'order' => 'desc'
							...
							<article id="post-<?php the_ID(); ?>" role="article" class="news-article-stub">
                                <?php if($image != "") { ?><img src="<?php echo $image; ?>" style="float:left; margin-right:15px;margin-bottom:0px;" width="115" height="115"> <?php } ?>
							...
							<?php endwhile; else : ?>
									...
									<article id="post-not-found" class="hentry clearfix">
										<header class="article-header">
											<?php _e( 'No upcoming events around Central Florida.', 'bonestheme' ); ?>
										</header>
									</article>
