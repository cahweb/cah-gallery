...
$image = kd_mfi_get_featured_image_url('featured-image-2', 'exhibit', 'full', get_the_ID());
...
if($image == "") 
$image = kd_mfi_get_featured_image_url( 'artist-image', 'exhibit' );
...
if($image == "") $image = $placeHolderImage;
                            ...
                            ?>
                            <a type="<?php echo get_post_type(); ?>" href="<?php the_permalink(); ?>" id="<?php echo count($years); ?>" class="<?php echo $year; ?> exhibit-prev hidden" startdate="<?php echo $sdate; ?>" enddate="<?php echo $edate; ?>">
                        ...
                        <div class="col-md-2 eventsfilter">
                        <h4>Upcoming Gallery Events</h4>
                        	<a href="#" id="select-all" onclick="filter_type('all')" class="exhibit-prev-link">All Events</a><br/>
                        	<a href="#" id="select-exhibit" onclick="filter_type('exhibit')" class="exhibit-prev-link">Exhibitions</a><br/>
                            <a href="#" id="select-event" onclick="filter_type('event')" class="exhibit-prev-link">Other Events</a><br/>
                            <hr />
							...
							arsort($years); 
                                foreach($years as $year) {
                                    echo '<a href="#" id="select-'.$year.'" onclick="filter('.$year.', false)" class="exhibit-prev-link">'.$year.'</a><br/>';   
                                }
                            ?>
                        </div>
                        <div class="col-md-1 hidden-xs hidden-sm"></div>
